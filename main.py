...
def main():
    ...
    try:
        ...
        book = Workbook()
        sheet = book.active
        # Agregar la fila de encabezados a partir de la consulta
    ...
    # 9. Si se ejecuta en GitHub Actions, se establece la salida para usar el nombre del archivo en el flujo (por ejemplo, para OneDrive)
